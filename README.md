...
│       ├── landuse_features.csv                 # 1000-node floodplain land use features
│       ├── soil_features.csv                    # 1000-node soil composition features
│       ├── vegetation_features.csv              # 1000-node riparian vegetation features
